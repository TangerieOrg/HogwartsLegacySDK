...
#pragma pack(push, 1)
class UABL_NpcReact_Levioso_Duel_C : public UAblReactionAbility {
public:
    FPointerToUberGraphFrame UberGraphFrame; // 0xe0
    ACharacter* TempCharRef; // 0xe8
    static UABL_NpcReact_Levioso_Duel_C* StaticClass();
