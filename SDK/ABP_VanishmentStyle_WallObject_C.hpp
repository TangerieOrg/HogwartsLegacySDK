...
class AActor;
#pragma pack(push, 1)
class ABP_VanishmentStyle_WallObject_C : public AVanishmentStyleBase {
public:
    ...
    static ABP_VanishmentStyle_WallObject_C* StaticClass();
    void StartVanishment();
    void ExecuteUbergraph_BP_VanishmentStyle_WallObject(int32_t EntryPoint, AActor* CallFunc_GetOwner_ReturnValue);
}; // Size: 0x2d0
#pragma pack(pop)
