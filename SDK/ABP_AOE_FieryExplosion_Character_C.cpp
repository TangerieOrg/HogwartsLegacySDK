#include "AActor.hpp"
#include "ABP_AOE_FieryExplosion_Character_C.hpp"
...
ABP_AOE_FieryExplosion_Character_C* ABP_AOE_FieryExplosion_Character_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Gameplay/Munitions/BP_AOE_FieryExplosion_Character.BP_AOE_FieryExplosion_Character_C");
    return (ABP_AOE_FieryExplosion_Character_C*)res;
}
void ABP_AOE_FieryExplosion_Character_C::OnHit0(FMunitionImpactData& MunitionImpact, FHitResult& HitResult, bool bHit, bool bBlocked, bool bFailed) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Gameplay/Munitions/BP_AOE_FieryExplosion_Character.BP_AOE_FieryExplosion_Character_C.OnHit"));
    struct Params_OnHit {
...
void ABP_AOE_FieryExplosion_Character_C::ExecuteUbergraph_BP_AOE_FieryExplosion_Character(int32_t EntryPoint, FMunitionImpactData K2Node_Event_MunitionImpact, FHitResult K2Node_Event_HitResult, bool K2Node_Event_bHit, bool K2Node_Event_bBlocked, bool K2Node_Event_bFailed, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, FVector CallFunc_BreakHitResult_Location, FVector CallFunc_BreakHitResult_ImpactPoint, FVector CallFunc_BreakHitResult_Normal, FVector CallFunc_BreakHitResult_ImpactNormal, UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, AActor* CallFunc_BreakHitResult_HitActor, UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, FName CallFunc_BreakHitResult_HitBoneName, int32_t CallFunc_BreakHitResult_HitItem, int32_t CallFunc_BreakHitResult_ElementIndex, int32_t CallFunc_BreakHitResult_FaceIndex, FVector CallFunc_BreakHitResult_TraceStart, FVector CallFunc_BreakHitResult_TraceEnd, bool CallFunc_SetOnFire_ReturnValue) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Gameplay/Munitions/BP_AOE_FieryExplosion_Character.BP_AOE_FieryExplosion_Character_C.ExecuteUbergraph_BP_AOE_FieryExplosion_Character"));
    struct Params_ExecuteUbergraph_BP_AOE_FieryExplosion_Character {
        ...
        bool CallFunc_SetOnFire_ReturnValue; // 0x204
    }; // Size: 0x205
    Params_ExecuteUbergraph_BP_AOE_FieryExplosion_Character params{};
