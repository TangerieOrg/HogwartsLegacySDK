...
class AActor;
#pragma pack(push, 1)
class UBP_EQS_Creature_QueryContext_MoveTargetLocation_C : public UEnvQueryContext_BlueprintBase {
public:
    static UBP_EQS_Creature_QueryContext_MoveTargetLocation_C* StaticClass();
