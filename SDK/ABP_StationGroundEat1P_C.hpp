...
#pragma pack(push, 1)
class ABP_StationGroundEat1P_C : public ABP_Station_Propless1p_C {
public:
    ...
    static ABP_StationGroundEat1P_C* StaticClass();
    void ReceiveBeginPlay();
    void ExecuteUbergraph_BP_StationGroundEat1P(int32_t EntryPoint);
}; // Size: 0x428
#pragma pack(pop)
