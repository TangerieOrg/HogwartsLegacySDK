...
#include "FVector.hpp"
#pragma pack(push, 1)
class ABP_TeleportSwimming_Marker_C : public ABP_Marker_Base_C {
public:
    FPointerToUberGraphFrame UberGraphFrame0; // 0x308
    static ABP_TeleportSwimming_Marker_C* StaticClass();
    ...
    void ExecuteUbergraph_BP_TeleportSwimming_Marker(int32_t EntryPoint);
}; // Size: 0x310
#pragma pack(pop)
