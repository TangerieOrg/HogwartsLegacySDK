...
class UAblAbility;
#pragma pack(push, 1)
class UABL_HitPetrificusFallDown_C : public UAblReactionAbility {
public:
    FPointerToUberGraphFrame UberGraphFrame; // 0xe0
    static UABL_HitPetrificusFallDown_C* StaticClass();
    ...
    void ExecuteUbergraph_ABL_HitPetrificusFallDown(int32_t EntryPoint, UAblAbilityContext* K2Node_Event_Context, UAblAbility* K2Node_Event_NextAbility);
}; // Size: 0xe8
#pragma pack(pop)
