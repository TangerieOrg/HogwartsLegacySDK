...
class AActor;
#pragma pack(push, 1)
class UABL_RCT_DGBG_HangByTongue_Loop_C : public UAblReactionAbility {
public:
    FPointerToUberGraphFrame UberGraphFrame; // 0xe0
    static UABL_RCT_DGBG_HangByTongue_Loop_C* StaticClass();
