...
#pragma pack(push, 1)
class UBTT_ScheduleRestSearch_C : public UBTTask_AvaAITree {
public:
    ...
    bool SideWork; // 0xe8
    char pad_e9[0x7];
    static UBTT_ScheduleRestSearch_C* StaticClass();
