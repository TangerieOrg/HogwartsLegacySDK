...
#include "UBP_AnmShrProc_ThreeIdles_C.hpp"
#include "UEnum.hpp"
#include "UFunction.hpp"
#include "UT4_AnimationSharingStateProcessor.hpp"
UBP_AnmShrProc_ThreeIdles_C* UBP_AnmShrProc_ThreeIdles_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Pawn/NPC/Tier4/SharedAnimData/BP_AnmShrProc_ThreeIdles.BP_AnmShrProc_ThreeIdles_C");
    return (UBP_AnmShrProc_ThreeIdles_C*)res;
}
void UBP_AnmShrProc_ThreeIdles_C::GetUsesEyeMouthAnims0(uint8_t InCurrentState, bool& bOutUsesEyeAnims, bool& bOutUsesMouthAnims) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/NPC/Tier4/SharedAnimData/BP_AnmShrProc_ThreeIdles.BP_AnmShrProc_ThreeIdles_C.GetUsesEyeMouthAnims"));
...
EFacialAnimType UBP_AnmShrProc_ThreeIdles_C::GetFacialAnimType0(uint8_t InCurrentState, uint8_t CallFunc_GetValidValue_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/NPC/Tier4/SharedAnimData/BP_AnmShrProc_ThreeIdles.BP_AnmShrProc_ThreeIdles_C.GetFacialAnimType"));
...
UEnum* UBP_AnmShrProc_ThreeIdles_C::GetAnimationStateEnum() {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/NPC/Tier4/SharedAnimData/BP_AnmShrProc_ThreeIdles.BP_AnmShrProc_ThreeIdles_C.GetAnimationStateEnum"));
...
void UBP_AnmShrProc_ThreeIdles_C::ProcessActorState(int32_t& OutState, AActor* InActor, uint8_t CurrentState, uint8_t OnDemandState, bool& bShouldProcess, int32_t CallFunc_UpdateT4State_OutState, bool CallFunc_UpdateT4State_bShouldProcess) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/NPC/Tier4/SharedAnimData/BP_AnmShrProc_ThreeIdles.BP_AnmShrProc_ThreeIdles_C.ProcessActorState"));
