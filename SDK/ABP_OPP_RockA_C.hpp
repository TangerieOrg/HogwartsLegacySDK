...
class AActor;
#pragma pack(push, 1)
class ABP_OPP_RockA_C : public AWorldObject {
public:
    ...
    static ABP_OPP_RockA_C* StaticClass();
    ...
    void ExecuteUbergraph_BP_OPP_RockA(int32_t EntryPoint, TArray<FAkExternalSourceInfo>& Temp_struct_Variable);
}; // Size: 0x2c8
#pragma pack(pop)
