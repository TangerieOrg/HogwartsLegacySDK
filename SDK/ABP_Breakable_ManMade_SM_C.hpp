...
#pragma pack(push, 1)
class ABP_Breakable_ManMade_SM_C : public AActor {
public:
    FPointerToUberGraphFrame UberGraphFrame; // 0x248
    UChildActorComponent* BP_Int_CastleDun_Stool_B_W; // 0x250
