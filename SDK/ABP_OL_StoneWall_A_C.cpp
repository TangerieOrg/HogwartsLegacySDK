#include "AActor.hpp"
#include "ABP_OL_StoneWall_A_C.hpp"
...
ABP_OL_StoneWall_A_C* ABP_OL_StoneWall_A_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Environment/Overland_Common/Objects/RockWall/Blueprints/BP_OL_StoneWall_A.BP_OL_StoneWall_A_C");
    return (ABP_OL_StoneWall_A_C*)res;
}
void ABP_OL_StoneWall_A_C::RequestDestroyComponent(UInstancedStaticMeshComponent* ISM_Component, bool& Success, TArray<UInstancedStaticMeshComponent*>& CallFunc_K2_GetComponentsByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue, int32_t CallFunc_Array_Find_ReturnValue, UInstancedStaticMeshComponent* CallFunc_Array_Get_Item, bool CallFunc_Array_Contains_ReturnValue) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Overland_Common/Objects/RockWall/Blueprints/BP_OL_StoneWall_A.BP_OL_StoneWall_A_C.RequestDestroyComponent"));
