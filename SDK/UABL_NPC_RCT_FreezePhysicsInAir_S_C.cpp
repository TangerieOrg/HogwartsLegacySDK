...
#include "UABL_NPC_RCT_FreezePhysicsInAir_S_C.hpp"
...
void UABL_NPC_RCT_FreezePhysicsInAir_S_C::OnAbilityBranch(UAblAbilityContext* Context, UAblAbility* NextAbility) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/NPC/Shared/Abilities/Reactions/ABL_NPC_RCT_FreezePhysicsInAir_S.ABL_NPC_RCT_FreezePhysicsInAir_S_C.OnAbilityBranch"));
...
UABL_NPC_RCT_FreezePhysicsInAir_S_C* UABL_NPC_RCT_FreezePhysicsInAir_S_C::StaticClass() {
    static auto res = find_uobject("AblAbilityBlueprintGeneratedClass /Game/Pawn/NPC/Shared/Abilities/Reactions/ABL_NPC_RCT_FreezePhysicsInAir_S.ABL_NPC_RCT_FreezePhysicsInAir_S_C");
    return (UABL_NPC_RCT_FreezePhysicsInAir_S_C*)res;
}
void UABL_NPC_RCT_FreezePhysicsInAir_S_C::ExecuteUbergraph_ABL_NPC_RCT_FreezePhysicsInAir_S(int32_t EntryPoint, UAblAbility* CallFunc_GetAbilityObjectFromClass_ReturnValue, UAblAbilityContext* K2Node_Event_Context, UAblAbility* K2Node_Event_NextAbility, UAblAbility* CallFunc_GetAbilityObjectFromClass_ReturnValue_1, bool CallFunc_NotEqual_ObjectObject_ReturnValue, bool CallFunc_NotEqual_ObjectObject_ReturnValue_1, AActor* CallFunc_GetSelfActor_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, ANPC_Character* K2Node_DynamicCast_AsNPC_Character, bool K2Node_DynamicCast_bSuccess, UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, UAble_AnimInstance* K2Node_DynamicCast_AsAble_Anim_Instance, bool K2Node_DynamicCast_bSuccess_1) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/NPC/Shared/Abilities/Reactions/ABL_NPC_RCT_FreezePhysicsInAir_S.ABL_NPC_RCT_FreezePhysicsInAir_S_C.ExecuteUbergraph_ABL_NPC_RCT_FreezePhysicsInAir_S"));
    struct Params_ExecuteUbergraph_ABL_NPC_RCT_FreezePhysicsInAir_S {
        ...
        UAble_AnimInstance* K2Node_DynamicCast_AsAble_Anim_Instance; // 0x58
        bool K2Node_DynamicCast_bSuccess_1; // 0x60
    }; // Size: 0x61
    Params_ExecuteUbergraph_ABL_NPC_RCT_FreezePhysicsInAir_S params{};
