...
#include "ABP_SeekDiveSpot_Marker_C.hpp"
...
void ABP_SeekDiveSpot_Marker_C::ReceiveBeginPlay() {
    static auto func = (UFunction*)(find_uobject("Function /Game/Gameplay/Blueprints/Overland/BP_SeekDiveSpot_Marker.BP_SeekDiveSpot_Marker_C.ReceiveBeginPlay"));
    struct Params_ReceiveBeginPlay {
    }; // Size: 0x0
    Params_ReceiveBeginPlay params{};
    ProcessEvent(func, &params);
}
ABP_SeekDiveSpot_Marker_C* ABP_SeekDiveSpot_Marker_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Gameplay/Blueprints/Overland/BP_SeekDiveSpot_Marker.BP_SeekDiveSpot_Marker_C");
    return (ABP_SeekDiveSpot_Marker_C*)res;
}
void ABP_SeekDiveSpot_Marker_C::ExecuteUbergraph_BP_SeekDiveSpot_Marker(int32_t EntryPoint) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Gameplay/Blueprints/Overland/BP_SeekDiveSpot_Marker.BP_SeekDiveSpot_Marker_C.ExecuteUbergraph_BP_SeekDiveSpot_Marker"));
    struct Params_ExecuteUbergraph_BP_SeekDiveSpot_Marker {
        int32_t EntryPoint; // 0x0
    }; // Size: 0x4
    Params_ExecuteUbergraph_BP_SeekDiveSpot_Marker params{};
    params.EntryPoint = (int32_t)EntryPoint;
    ProcessEvent(func, &params);
}
void ABP_SeekDiveSpot_Marker_C::UserConstructionScript(FColor K2Node_MakeStruct_Color, bool CallFunc_InitMarker_Valid, ABeaconLocation* K2Node_DynamicCast_AsBeacon_Location, bool K2Node_DynamicCast_bSuccess, FRotator CallFunc_K2_GetActorRotation_ReturnValue, FVector CallFunc_K2_GetActorLocation_ReturnValue, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Gameplay/Blueprints/Overland/BP_SeekDiveSpot_Marker.BP_SeekDiveSpot_Marker_C.UserConstructionScript"));
