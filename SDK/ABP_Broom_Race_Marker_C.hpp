...
#pragma pack(push, 1)
class ABP_Broom_Race_Marker_C : public ABP_Marker_Base_C {
public:
    ...
    static ABP_Broom_Race_Marker_C* StaticClass();
    ...
    void ExecuteUbergraph_BP_Broom_Race_Marker(int32_t EntryPoint);
}; // Size: 0x320
#pragma pack(pop)
