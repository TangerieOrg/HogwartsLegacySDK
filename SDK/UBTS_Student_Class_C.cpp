...
#include "UBTS_Student_Class_C.hpp"
#include "UBTService_AvaAITree.hpp"
#include "UEnvQueryInstanceBlueprintWrapper.hpp"
#include "UFunction.hpp"
#include "UObject.hpp"
UBTS_Student_Class_C* UBTS_Student_Class_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Pawn/Student/BTS_Student_Class.BTS_Student_Class_C");
    return (UBTS_Student_Class_C*)res;
}
void UBTS_Student_Class_C::Nevermind(UObject* Caller) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/BTS_Student_Class.BTS_Student_Class_C.Nevermind"));
...
void UBTS_Student_Class_C::ReceiveSearchStart(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/BTS_Student_Class.BTS_Student_Class_C.ReceiveSearchStart"));
...
void UBTS_Student_Class_C::ExcuseMe(UObject* Caller) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/BTS_Student_Class.BTS_Student_Class_C.ExcuseMe"));
...
void UBTS_Student_Class_C::ServiceEnd0(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/BTS_Student_Class.BTS_Student_Class_C.ServiceEnd"));
...
void UBTS_Student_Class_C::ServiceBegin0(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/BTS_Student_Class.BTS_Student_Class_C.ServiceBegin"));
...
void UBTS_Student_Class_C::OnQueryFinishedEvent_Event_1(UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus::Type QueryStatus) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/BTS_Student_Class.BTS_Student_Class_C.OnQueryFinishedEvent_Event_1"));
...
void UBTS_Student_Class_C::ReceiveTick(AActor* OwnerActor, float DeltaSeconds) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/BTS_Student_Class.BTS_Student_Class_C.ReceiveTick"));
...
void UBTS_Student_Class_C::OnQueryFinishedEvent_Event_0(UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus::Type QueryStatus) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/BTS_Student_Class.BTS_Student_Class_C.OnQueryFinishedEvent_Event_0"));
...
void UBTS_Student_Class_C::ExecuteUbergraph_BTS_Student_Class(int32_t EntryPoint, int32_t Temp_int_Loop_Counter_Variable, AActor* K2Node_Event_OwnerActor_2, int32_t CallFunc_Add_IntInt_ReturnValue, int32_t Temp_int_Array_Index_Variable, UEnvQueryInstanceBlueprintWrapper* K2Node_CustomEvent_QueryInstance_1, EEnvQueryStatus::Type K2Node_CustomEvent_QueryStatus_1, bool CallFunc_EqualEqual_ByteByte_ReturnValue, TArray<AActor*>& CallFunc_GetQueryResultsAsActors_ResultActors, bool CallFunc_GetQueryResultsAsActors_ReturnValue, AActor* CallFunc_Array_Get_Item, int32_t CallFunc_Array_Length_ReturnValue, AStation* K2Node_DynamicCast_AsStation, bool K2Node_DynamicCast_bSuccess, UObject* K2Node_CustomEvent_Caller, AActor* K2Node_Event_OwnerActor_1, float K2Node_Event_DeltaSeconds, AActor* K2Node_Event_OwnerActor, int32_t Temp_int_Loop_Counter_Variable_1, AActor* K2Node_Event_OwnerActor_3, bool CallFunc_Less_IntInt_ReturnValue, int32_t CallFunc_Add_IntInt_ReturnValue_1, int32_t Temp_int_Array_Index_Variable_1, UEnvQueryInstanceBlueprintWrapper* K2Node_CustomEvent_QueryInstance, EEnvQueryStatus::Type K2Node_CustomEvent_QueryStatus, UObject* K2Node_CustomEvent_Caller_1, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, TArray<AActor*>& CallFunc_GetQueryResultsAsActors_ResultActors_1, bool CallFunc_GetQueryResultsAsActors_ReturnValue_1, AActor* CallFunc_Array_Get_Item_1, int32_t CallFunc_Array_Length_ReturnValue_1, AStation* K2Node_DynamicCast_AsStation_1, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_Less_IntInt_ReturnValue_1) {
    ...
    struct Params_ExecuteUbergraph_BTS_Student_Class {
        ...
        char pad_59[0x7];
        UObject* K2Node_CustomEvent_Caller; // 0x60
        AActor* K2Node_Event_OwnerActor_1; // 0x68
        float K2Node_Event_DeltaSeconds; // 0x70
        char pad_74[0x4];
        AActor* K2Node_Event_OwnerActor; // 0x78
        int32_t Temp_int_Loop_Counter_Variable_1; // 0x80
        char pad_84[0x4];
        AActor* K2Node_Event_OwnerActor_3; // 0x88
        bool CallFunc_Less_IntInt_ReturnValue; // 0x90
        char pad_91[0x3];
        int32_t CallFunc_Add_IntInt_ReturnValue_1; // 0x94
        int32_t Temp_int_Array_Index_Variable_1; // 0x98
        char pad_9c[0x4];
        UEnvQueryInstanceBlueprintWrapper* K2Node_CustomEvent_QueryInstance; // 0xa0
        EEnvQueryStatus::Type K2Node_CustomEvent_QueryStatus; // 0xa8
        char pad_a9[0x7];
        UObject* K2Node_CustomEvent_Caller_1; // 0xb0
        bool CallFunc_EqualEqual_ByteByte_ReturnValue_1; // 0xb8
        char pad_b9[0x7];
    ...
    Params_ExecuteUbergraph_BTS_Student_Class params{};
    ...
    params.K2Node_Event_OwnerActor_3 = (AActor*)K2Node_Event_OwnerActor_3;
