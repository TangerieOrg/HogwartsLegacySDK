...
class AActor;
#pragma pack(push, 1)
class ABP_HM_Neep_Pumpkin_B_C : public ABP_Breakable_Persistent_C {
public:
    ...
    char pad_370[0x10];
    static ABP_HM_Neep_Pumpkin_B_C* StaticClass();
