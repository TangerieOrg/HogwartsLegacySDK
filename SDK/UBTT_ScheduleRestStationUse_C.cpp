...
#include "UBTT_ScheduleRestStationUse_C.hpp"
#include "UBTTask_AvaAITree.hpp"
#include "UFunction.hpp"
#include "UScheduler.hpp"
UBTT_ScheduleRestStationUse_C* UBTT_ScheduleRestStationUse_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Pawn/Student/Ideas/BTT_ScheduleRestStationUse.BTT_ScheduleRestStationUse_C");
    return (UBTT_ScheduleRestStationUse_C*)res;
}
void UBTT_ScheduleRestStationUse_C::ReceiveExecute(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_ScheduleRestStationUse.BTT_ScheduleRestStationUse_C.ReceiveExecute"));
...
void UBTT_ScheduleRestStationUse_C::ExitTask0(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_ScheduleRestStationUse.BTT_ScheduleRestStationUse_C.ExitTask"));
...
void UBTT_ScheduleRestStationUse_C::ExecuteUbergraph_BTT_ScheduleRestStationUse(int32_t EntryPoint, AActor* K2Node_Event_OwnerActor_1, float CallFunc_Multiply_FloatFloat_ReturnValue, ASocialReasoning* K2Node_DynamicCast_AsSocial_Reasoning, bool K2Node_DynamicCast_bSuccess, AActor* K2Node_Event_OwnerActor, UScheduler* CallFunc_Get_ReturnValue, float CallFunc_GetSimulatedSecondMultiplier_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue_1) {
    ...
    Params_ExecuteUbergraph_BTT_ScheduleRestStationUse params{};
