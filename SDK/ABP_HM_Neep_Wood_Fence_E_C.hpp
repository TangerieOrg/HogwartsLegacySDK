...
#pragma pack(push, 1)
class ABP_HM_Neep_Wood_Fence_E_C : public ABP_Breakable_Persistent_C {
public:
    FPointerToUberGraphFrame UberGraphFrame; // 0x358
    static ABP_HM_Neep_Wood_Fence_E_C* StaticClass();
