...
struct FVector;
#pragma pack(push, 1)
class ABP_Sanc_PaintingCanvasLarge_01A_C : public ATransfigurationObjectBase {
public:
    ...
    static ABP_Sanc_PaintingCanvasLarge_01A_C* StaticClass();
    void ObjectConjured();
    ...
    void ExecuteUbergraph_BP_Sanc_PaintingCanvasLarge_01A(int32_t EntryPoint, TArray<FAkExternalSourceInfo>& Temp_struct_Variable);
}; // Size: 0x2e0
#pragma pack(pop)
