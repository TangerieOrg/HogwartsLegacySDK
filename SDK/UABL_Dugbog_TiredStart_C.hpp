...
#pragma pack(push, 1)
class UABL_Dugbog_TiredStart_C : public UAblAbility {
public:
    FPointerToUberGraphFrame UberGraphFrame; // 0xc8
    UAblAbility* NewVar_0; // 0xd0
    static UABL_Dugbog_TiredStart_C* StaticClass();
    ...
    void ExecuteUbergraph_ABL_Dugbog_TiredStart(int32_t EntryPoint, UAblAbilityContext* K2Node_Event_Context);
}; // Size: 0xd8
#pragma pack(pop)
