...
ABP_SelfArrangingBookshelf_Parent_C* ABP_SelfArrangingBookshelf_Parent_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Gameplay/Sanctuary/Blueprints/Structures/BP_SelfArrangingBookshelf_Parent.BP_SelfArrangingBookshelf_Parent_C");
    return (ABP_SelfArrangingBookshelf_Parent_C*)res;
}
void ABP_SelfArrangingBookshelf_Parent_C::SetUpSplineEffects(UObject* ChildActor, TArray<USplineComponent*>& SplineArray, int32_t CallFunc_Array_Length_ReturnValue, int32_t CallFunc_Array_Length_ReturnValue_1, ABP_AmbientPathEffects_C* K2Node_DynamicCast_AsBP_Ambient_Path_Effects, bool K2Node_DynamicCast_bSuccess, ABP_AmbientPathEffects_C* K2Node_DynamicCast_AsBP_Ambient_Path_Effects_1, bool K2Node_DynamicCast_bSuccess_1, int32_t Temp_int_Array_Index_Variable, int32_t Temp_int_Loop_Counter_Variable, USplineComponent* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, int32_t CallFunc_Add_IntInt_ReturnValue) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Gameplay/Sanctuary/Blueprints/Structures/BP_SelfArrangingBookshelf_Parent.BP_SelfArrangingBookshelf_Parent_C.SetUpSplineEffects"));
...
void ABP_SelfArrangingBookshelf_Parent_C::SetUpBookChildActor(UObject* ChildActor, TArray<USplineComponent*>& SplineArray, int32_t Temp_int_Array_Index_Variable, int32_t CallFunc_Array_Length_ReturnValue, USplineComponent* CallFunc_Array_Get_Item, int32_t CallFunc_Array_Length_ReturnValue_1, ABP_SelfArrangingBooks_C* K2Node_DynamicCast_AsBP_Self_Arranging_Books, bool K2Node_DynamicCast_bSuccess, ABP_SelfArrangingBooks_C* K2Node_DynamicCast_AsBP_Self_Arranging_Books_1, bool K2Node_DynamicCast_bSuccess_1, int32_t Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32_t CallFunc_Add_IntInt_ReturnValue) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Gameplay/Sanctuary/Blueprints/Structures/BP_SelfArrangingBookshelf_Parent.BP_SelfArrangingBookshelf_Parent_C.SetUpBookChildActor"));
