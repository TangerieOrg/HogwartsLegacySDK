...
void UUI_BP_InputActionAlt_Row_C::SetRebindingFlair(bool IsRebinding, FLinearColor HighlightColor, FLinearColor DefaultColor, UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue, UUMGSequencePlayer* CallFunc_PlayAnimationReverse_ReturnValue) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.SetRebindingFlair"));
...
UUI_BP_InputActionAlt_Row_C* UUI_BP_InputActionAlt_Row_C::StaticClass() {
    static auto res = find_uobject("WidgetBlueprintGeneratedClass /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C");
    return (UUI_BP_InputActionAlt_Row_C*)res;
}
TArray<FString> UUI_BP_InputActionAlt_Row_C::GatherMenuReaderStrings0(int32_t DepthLevel, TArray<FString> TempGatheredStrings, TArray<FString>& CallFunc_GatherMenuReaderStrings_ReturnValue, TArray<FString>& CallFunc_GatherMenuReaderStrings_ReturnValue_1, TArray<FString>& CallFunc_GatherMenuReaderStrings_ReturnValue_2) {}
void UUI_BP_InputActionAlt_Row_C::Construct() {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.Construct"));
    struct Params_Construct {
    }; // Size: 0x0
    Params_Construct params{};
    ProcessEvent(func, &params);
}
void UUI_BP_InputActionAlt_Row_C::UpdateTelemetry(bool IsPrimary, FString CallFunc_KeyToString_ReturnValue, FString CallFunc_KeyToString_ReturnValue_1, FString CallFunc_Conv_NameToString_ReturnValue, FString CallFunc_Conv_NameToString_ReturnValue_1, FString CallFunc_Concat_StrStr_ReturnValue, FString CallFunc_Concat_StrStr_ReturnValue_1) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.UpdateTelemetry"));
    struct Params_UpdateTelemetry {
        bool IsPrimary; // 0x0
        char pad_1[0x7];
        FString CallFunc_KeyToString_ReturnValue; // 0x8
        FString CallFunc_KeyToString_ReturnValue_1; // 0x18
        FString CallFunc_Conv_NameToString_ReturnValue; // 0x28
        FString CallFunc_Conv_NameToString_ReturnValue_1; // 0x38
...
void UUI_BP_InputActionAlt_Row_C::HandleUnhovered(bool IsPrimary, UUI_BP_InputAction_C* InputAction) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.HandleUnhovered"));
...
void UUI_BP_InputActionAlt_Row_C::HandleHovered(bool IsPrimary, UUI_BP_InputAction_C* InputAction) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.HandleHovered"));
...
void UUI_BP_InputActionAlt_Row_C::SetActionNameDefault(FDataTableRowHandle K2Node_MakeStruct_DataTableRowHandle) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.SetActionNameDefault"));
    struct Params_SetActionNameDefault {
        FDataTableRowHandle K2Node_MakeStruct_DataTableRowHandle; // 0x0
    }; // Size: 0x10
    Params_SetActionNameDefault params{};
    params.K2Node_MakeStruct_DataTableRowHandle = (FDataTableRowHandle)K2Node_MakeStruct_DataTableRowHandle;
    ProcessEvent(func, &params);
}
void UUI_BP_InputActionAlt_Row_C::HandleClicked(bool IsPrimary, UUI_BP_InputAction_C* InputAction) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.HandleClicked"));
...
void UUI_BP_InputActionAlt_Row_C::SetActionNameHighlight(FDataTableRowHandle K2Node_MakeStruct_DataTableRowHandle) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.SetActionNameHighlight"));
    struct Params_SetActionNameHighlight {
        FDataTableRowHandle K2Node_MakeStruct_DataTableRowHandle; // 0x0
    }; // Size: 0x10
    Params_SetActionNameHighlight params{};
    params.K2Node_MakeStruct_DataTableRowHandle = (FDataTableRowHandle)K2Node_MakeStruct_DataTableRowHandle;
    ProcessEvent(func, &params);
}
void UUI_BP_InputActionAlt_Row_C::ExecuteUbergraph_UI_BP_InputActionAlt_Row(int32_t EntryPoint, FString CallFunc_Conv_NameToString_ReturnValue, FString CallFunc_Concat_StrStr_ReturnValue) {}
void UUI_BP_InputActionAlt_Row_C::InputUnhovered__DelegateSignature(UUI_BP_InputActionAlt_Row_C* Row, bool IsPrimary) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.InputUnhovered__DelegateSignature"));
...
void UUI_BP_InputActionAlt_Row_C::InputHovered__DelegateSignature(UUI_BP_InputActionAlt_Row_C* Row, bool IsPrimary) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.InputHovered__DelegateSignature"));
...
void UUI_BP_InputActionAlt_Row_C::InputClicked__DelegateSignature(UUI_BP_InputActionAlt_Row_C* Row, bool IsPrimary) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/OptionsMenu/UI_BP_InputActionAlt_Row.UI_BP_InputActionAlt_Row_C.InputClicked__DelegateSignature"));
