...
#include "UBTT_Schedule_PatrolNoStation_C.hpp"
#include "UBTTask_AvaAITree.hpp"
#include "UFunction.hpp"
#include "UScheduler.hpp"
UBTT_Schedule_PatrolNoStation_C* UBTT_Schedule_PatrolNoStation_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Pawn/Student/Ideas/BTT_Schedule_PatrolNoStation.BTT_Schedule_PatrolNoStation_C");
    return (UBTT_Schedule_PatrolNoStation_C*)res;
}
void UBTT_Schedule_PatrolNoStation_C::ExecuteUbergraph_BTT_Schedule_PatrolNoStation(int32_t EntryPoint, AActor* K2Node_Event_OwnerActor_1, float CallFunc_Multiply_FloatFloat_ReturnValue, ASocialReasoning* K2Node_DynamicCast_AsSocial_Reasoning, bool K2Node_DynamicCast_bSuccess, AActor* K2Node_Event_OwnerActor, UScheduler* CallFunc_Get_ReturnValue, float CallFunc_GetSimulatedSecondMultiplier_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue_1) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_Schedule_PatrolNoStation.BTT_Schedule_PatrolNoStation_C.ExecuteUbergraph_BTT_Schedule_PatrolNoStation"));
    struct Params_ExecuteUbergraph_BTT_Schedule_PatrolNoStation {
    ...
    Params_ExecuteUbergraph_BTT_Schedule_PatrolNoStation params{};
...
void UBTT_Schedule_PatrolNoStation_C::ReceiveExecute(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_Schedule_PatrolNoStation.BTT_Schedule_PatrolNoStation_C.ReceiveExecute"));
...
void UBTT_Schedule_PatrolNoStation_C::ExitTask0(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_Schedule_PatrolNoStation.BTT_Schedule_PatrolNoStation_C.ExitTask"));
