...
#pragma pack(push, 1)
class UABL_NPC_RCT_FallNoSplat_C : public UAblReactionAbility {
public:
    FPointerToUberGraphFrame UberGraphFrame; // 0xe0
    ACharacter* TempCharRef; // 0xe8
    static UABL_NPC_RCT_FallNoSplat_C* StaticClass();
