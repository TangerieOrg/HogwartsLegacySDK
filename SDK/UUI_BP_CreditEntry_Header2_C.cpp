...
#include "UUI_BP_CreditEntry_Header2_C.hpp"
UUI_BP_CreditEntry_Header2_C* UUI_BP_CreditEntry_Header2_C::StaticClass() {
    static auto res = find_uobject("WidgetBlueprintGeneratedClass /Game/UI/Credits/UI_BP_CreditEntry_Header2.UI_BP_CreditEntry_Header2_C");
    return (UUI_BP_CreditEntry_Header2_C*)res;
}
void UUI_BP_CreditEntry_Header2_C::ExecuteUbergraph_UI_BP_CreditEntry_Header2(int32_t EntryPoint, float K2Node_Event_Progress, float CallFunc_Multiply_FloatFloat_ReturnValue, UCanvasPanelSlot* CallFunc_SlotAsCanvasSlot_ReturnValue, FMargin K2Node_MakeStruct_Margin, float CallFunc_Subtract_FloatFloat_ReturnValue, FVector2D CallFunc_MakeVector2D_ReturnValue, FVector2D CallFunc_MakeVector2D_ReturnValue_1, FCreditEntry K2Node_Event_CreditEntry, FAnchors K2Node_MakeStruct_Anchors) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/Credits/UI_BP_CreditEntry_Header2.UI_BP_CreditEntry_Header2_C.ExecuteUbergraph_UI_BP_CreditEntry_Header2"));
    struct Params_ExecuteUbergraph_UI_BP_CreditEntry_Header2 {
    ...
    Params_ExecuteUbergraph_UI_BP_CreditEntry_Header2 params{};
...
void UUI_BP_CreditEntry_Header2_C::SetCreditEntryAnimProgress(float Progress) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/Credits/UI_BP_CreditEntry_Header2.UI_BP_CreditEntry_Header2_C.SetCreditEntryAnimProgress"));
...
void UUI_BP_CreditEntry_Header2_C::SetCreditEntryInfo(FCreditEntry CreditEntry) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/Credits/UI_BP_CreditEntry_Header2.UI_BP_CreditEntry_Header2_C.SetCreditEntryInfo"));
