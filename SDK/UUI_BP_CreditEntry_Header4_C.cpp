...
#include "UUI_BP_CreditEntry_Header4_C.hpp"
UUI_BP_CreditEntry_Header4_C* UUI_BP_CreditEntry_Header4_C::StaticClass() {
    static auto res = find_uobject("WidgetBlueprintGeneratedClass /Game/UI/Credits/UI_BP_CreditEntry_Header4.UI_BP_CreditEntry_Header4_C");
    return (UUI_BP_CreditEntry_Header4_C*)res;
}
void UUI_BP_CreditEntry_Header4_C::SetCreditEntryInfo0(FCreditEntry CreditEntry) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/Credits/UI_BP_CreditEntry_Header4.UI_BP_CreditEntry_Header4_C.SetCreditEntryInfo"));
...
void UUI_BP_CreditEntry_Header4_C::SetCreditEntryAnimProgress0(float Progress) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/Credits/UI_BP_CreditEntry_Header4.UI_BP_CreditEntry_Header4_C.SetCreditEntryAnimProgress"));
...
void UUI_BP_CreditEntry_Header4_C::ExecuteUbergraph_UI_BP_CreditEntry_Header4(int32_t EntryPoint, float K2Node_Event_Progress, float CallFunc_Multiply_FloatFloat_ReturnValue, UCanvasPanelSlot* CallFunc_SlotAsCanvasSlot_ReturnValue, FMargin K2Node_MakeStruct_Margin, float CallFunc_Subtract_FloatFloat_ReturnValue, FVector2D CallFunc_MakeVector2D_ReturnValue, FVector2D CallFunc_MakeVector2D_ReturnValue_1, FCreditEntry K2Node_Event_CreditEntry, FAnchors K2Node_MakeStruct_Anchors) {
    static auto func = (UFunction*)(find_uobject("Function /Game/UI/Credits/UI_BP_CreditEntry_Header4.UI_BP_CreditEntry_Header4_C.ExecuteUbergraph_UI_BP_CreditEntry_Header4"));
    struct Params_ExecuteUbergraph_UI_BP_CreditEntry_Header4 {
    ...
    Params_ExecuteUbergraph_UI_BP_CreditEntry_Header4 params{};
