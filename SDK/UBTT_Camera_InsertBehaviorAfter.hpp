...
public:
    ...
    TArray<UClass*> InsertAfterBehaviorClass; // 0x80
    ECameraStackBehaviorSorting InsertAfterBehaviorSorting; // 0x90
    char pad_91[0x3];
    int32_t FilterFlags; // 0x94
    bool bReuseBehaviorOnReactivate; // 0x98
    char pad_99[0x7];
    static UBTT_Camera_InsertBehaviorAfter* StaticClass();
}; // Size: 0xa0
#pragma pack(pop)
