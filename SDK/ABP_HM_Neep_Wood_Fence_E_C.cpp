...
#include "ABP_HM_Neep_Wood_Fence_E_C.hpp"
...
void ABP_HM_Neep_Wood_Fence_E_C::OnAttemptToHeal() {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnAttemptToHeal"));
    struct Params_OnAttemptToHeal {
    }; // Size: 0x0
    Params_OnAttemptToHeal params{};
    ProcessEvent(func, &params);
}
ABP_HM_Neep_Wood_Fence_E_C* ABP_HM_Neep_Wood_Fence_E_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C");
    return (ABP_HM_Neep_Wood_Fence_E_C*)res;
}
void ABP_HM_Neep_Wood_Fence_E_C::OnAttemptToRepair() {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnAttemptToRepair"));
    struct Params_OnAttemptToRepair {
    }; // Size: 0x0
    Params_OnAttemptToRepair params{};
    ProcessEvent(func, &params);
}
void ABP_HM_Neep_Wood_Fence_E_C::OnGeometryCollectionDamaged(URepairComponent* RepairComponent, UGeometryCollectionComponent* GeometryCollectionComponent, float impulseStr, float Radius, FVector HitLocation, FVector HitDirection) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnGeometryCollectionDamaged"));
...
bool ABP_HM_Neep_Wood_Fence_E_C::Damaged(float DamageAmount, FVector HitLocation, FVector HitDirection, UPrimitiveComponent* PrimComp, FGameplayTagContainer MunitionTagContainer, AActor* Instigator, FVector Velocity) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.Damaged"));
...
void ABP_HM_Neep_Wood_Fence_E_C::OnCriticalHealthReached() {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnCriticalHealthReached"));
    struct Params_OnCriticalHealthReached {
    }; // Size: 0x0
    Params_OnCriticalHealthReached params{};
    ProcessEvent(func, &params);
}
bool ABP_HM_Neep_Wood_Fence_E_C::Destroyed(float DamageAmount, AActor* Instigator, FGameplayTagContainer MunitionTagContainer, FVector Velocity, FVector CallFunc_K2_GetComponentLocation_ReturnValue, FVector CallFunc_Add_VectorVector_ReturnValue, int32_t CallFunc_PostEventAtLocation_ReturnValue) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.Destroyed"));
...
void ABP_HM_Neep_Wood_Fence_E_C::OnGeometryCollectionSpawned(URepairComponent* RepairComponent, UGeometryCollectionComponent* GeometryCollectionComponent, float impulseStr, float Radius, FVector HitLocation, FVector HitDirection, bool bCompletelyBroken) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnGeometryCollectionSpawned"));
...
bool ABP_HM_Neep_Wood_Fence_E_C::NearDeathKneeling(float DamageAmount, AActor* Instigator, FGameplayTagContainer MunitionTagContainer, FVector Velocity) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.NearDeathKneeling"));
...
void ABP_HM_Neep_Wood_Fence_E_C::OnBeginRepairing() {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnBeginRepairing"));
    struct Params_OnBeginRepairing {
    }; // Size: 0x0
    Params_OnBeginRepairing params{};
    ProcessEvent(func, &params);
}
void ABP_HM_Neep_Wood_Fence_E_C::OnDoneRepairing() {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnDoneRepairing"));
    struct Params_OnDoneRepairing {
    }; // Size: 0x0
    Params_OnDoneRepairing params{};
    ProcessEvent(func, &params);
}
void ABP_HM_Neep_Wood_Fence_E_C::OnFailedToBeDamaged(float DamageAmount, FVector HitLocation, FVector HitDirection, UPrimitiveComponent* PrimComp, FGameplayTagContainer MunitionTagContainer, AActor* Instigator, FVector Velocity) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnFailedToBeDamaged"));
...
void ABP_HM_Neep_Wood_Fence_E_C::OnFailedToBeDestroyed() {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnFailedToBeDestroyed"));
    struct Params_OnFailedToBeDestroyed {
    }; // Size: 0x0
    Params_OnFailedToBeDestroyed params{};
    ProcessEvent(func, &params);
}
void ABP_HM_Neep_Wood_Fence_E_C::OnFailedToBeHealed() {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnFailedToBeHealed"));
    struct Params_OnFailedToBeHealed {
    }; // Size: 0x0
    Params_OnFailedToBeHealed params{};
    ProcessEvent(func, &params);
}
void ABP_HM_Neep_Wood_Fence_E_C::OnGeometryCollectionCompletelyBroken(URepairComponent* RepairComponent, UGeometryCollectionComponent* GeometryCollectionComponent, float impulseStr, float Radius, FVector HitLocation, FVector HitDirection) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnGeometryCollectionCompletelyBroken"));
...
void ABP_HM_Neep_Wood_Fence_E_C::OnHealed(float healAmount, UPrimitiveComponent* PrimComp) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Environment/Hogsmeade/Blueprints/Interactables/BP_HM_Neep_Wood_Fence_E.BP_HM_Neep_Wood_Fence_E_C.OnHealed"));
...
void ABP_HM_Neep_Wood_Fence_E_C::ExecuteUbergraph_BP_HM_Neep_Wood_Fence_E(int32_t EntryPoint, float K2Node_Event_healAmount, UPrimitiveComponent* K2Node_Event_primComp, float K2Node_Event_damageAmount, FVector K2Node_Event_hitLocation_3, FVector K2Node_Event_hitDirection_3, UPrimitiveComponent* K2Node_Event_primComp_1, FGameplayTagContainer K2Node_Event_MunitionTagContainer, AActor* K2Node_Event_Instigator, FVector K2Node_Event_Velocity, URepairComponent* K2Node_Event_RepairComponent_2, UGeometryCollectionComponent* K2Node_Event_GeometryCollectionComponent_2, float K2Node_Event_impulseStr_2, float K2Node_Event_Radius_2, FVector K2Node_Event_hitLocation_2, FVector K2Node_Event_hitDirection_2, URepairComponent* K2Node_Event_RepairComponent_1, UGeometryCollectionComponent* K2Node_Event_GeometryCollectionComponent_1, float K2Node_Event_impulseStr_1, float K2Node_Event_Radius_1, FVector K2Node_Event_hitLocation_1, FVector K2Node_Event_hitDirection_1, URepairComponent* K2Node_Event_RepairComponent, UGeometryCollectionComponent* K2Node_Event_GeometryCollectionComponent, float K2Node_Event_impulseStr, float K2Node_Event_Radius, FVector K2Node_Event_hitLocation, FVector K2Node_Event_hitDirection, bool K2Node_Event_bCompletelyBroken) {
    ...
    Params_ExecuteUbergraph_BP_HM_Neep_Wood_Fence_E params{};
