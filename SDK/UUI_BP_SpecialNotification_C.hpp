...
class UObject;
#pragma pack(push, 1)
class UUI_BP_SpecialNotification_C : public UHUDElementGroup {
public:
    ...
    FString ItemName; // 0x330
    static UUI_BP_SpecialNotification_C* StaticClass();
