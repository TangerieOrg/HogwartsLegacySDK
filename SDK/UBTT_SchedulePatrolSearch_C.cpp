...
#include "UBTT_SchedulePatrolSearch_C.hpp"
...
UBTT_SchedulePatrolSearch_C* UBTT_SchedulePatrolSearch_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Pawn/Student/Ideas/BTT_SchedulePatrolSearch.BTT_SchedulePatrolSearch_C");
    return (UBTT_SchedulePatrolSearch_C*)res;
}
void UBTT_SchedulePatrolSearch_C::ReceiveExecute(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_SchedulePatrolSearch.BTT_SchedulePatrolSearch_C.ReceiveExecute"));
...
void UBTT_SchedulePatrolSearch_C::ExitTask0(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_SchedulePatrolSearch.BTT_SchedulePatrolSearch_C.ExitTask"));
...
void UBTT_SchedulePatrolSearch_C::Patrol_Job_OnQueryFinished(UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus::Type QueryStatus) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_SchedulePatrolSearch.BTT_SchedulePatrolSearch_C.Patrol_Job_OnQueryFinished"));
