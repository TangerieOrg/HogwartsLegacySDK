...
#pragma pack(push, 1)
class UABL_NPC_RCT_Levioso_End_C : public UAblReactionAbility {
public:
    FPointerToUberGraphFrame UberGraphFrame; // 0xe0
    ACharacter* TempCharRef; // 0xe8
    static UABL_NPC_RCT_Levioso_End_C* StaticClass();
    void CleanUpEffectComponent(UAblAbilityContext* Context, UAblReactionData* CallFunc_GetReactionData_ReturnValue, bool CallFunc_IsValid_ReturnValue);
