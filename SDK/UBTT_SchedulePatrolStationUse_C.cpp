...
#include "UBTT_SchedulePatrolStationUse_C.hpp"
#include "UBTTask_AvaAITree.hpp"
#include "UFunction.hpp"
#include "UScheduler.hpp"
UBTT_SchedulePatrolStationUse_C* UBTT_SchedulePatrolStationUse_C::StaticClass() {
    static auto res = find_uobject("BlueprintGeneratedClass /Game/Pawn/Student/Ideas/BTT_SchedulePatrolStationUse.BTT_SchedulePatrolStationUse_C");
    return (UBTT_SchedulePatrolStationUse_C*)res;
}
void UBTT_SchedulePatrolStationUse_C::ReceiveExecute(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_SchedulePatrolStationUse.BTT_SchedulePatrolStationUse_C.ReceiveExecute"));
...
void UBTT_SchedulePatrolStationUse_C::ExitTask(AActor* OwnerActor) {
    static auto func = (UFunction*)(find_uobject("Function /Game/Pawn/Student/Ideas/BTT_SchedulePatrolStationUse.BTT_SchedulePatrolStationUse_C.ExitTask"));
...
void UBTT_SchedulePatrolStationUse_C::ExecuteUbergraph_BTT_SchedulePatrolStationUse(int32_t EntryPoint, AActor* K2Node_Event_OwnerActor_1, float CallFunc_Multiply_FloatFloat_ReturnValue, ASocialReasoning* K2Node_DynamicCast_AsSocial_Reasoning, bool K2Node_DynamicCast_bSuccess, AActor* K2Node_Event_OwnerActor, UScheduler* CallFunc_Get_ReturnValue, float CallFunc_GetSimulatedSecondMultiplier_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue_1) {
    ...
    Params_ExecuteUbergraph_BTT_SchedulePatrolStationUse params{};
