...
class UObject;
#pragma pack(push, 1)
class UBTT_Creature_CopyStance_C : public UBTTask_BlueprintBase {
public:
    FPointerToUberGraphFrame UberGraphFrame; // 0xa8
    ECreatureStance DesiredStance; // 0xb0
    bool Wait; // 0xb1
    char pad_b2[0x6];
    FBlackboardKeySelector TargetActor; // 0xb8
    static UBTT_Creature_CopyStance_C* StaticClass();
