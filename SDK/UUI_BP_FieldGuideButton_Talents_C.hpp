...
#pragma pack(push, 1)
class UUI_BP_FieldGuideButton_Talents_C : public UFieldGuideButton_Talents {
public:
    ...
    static UUI_BP_FieldGuideButton_Talents_C* StaticClass();
    void SequenceEvent__ENTRYPOINTUI_BP_FieldGuideButton_Talents_0();
